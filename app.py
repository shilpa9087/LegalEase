...
file_path = r"C:\Users\Dell\Documents\Textsummarizer\data\The Indian Contract Act, 1872.pdf"
...
from src.summarizer import extract_text_from_pdf, summarize_text
...
if uploaded_file:
    with open("data/notice.pdf", "wb") as f: 
        f.write(uploaded_file.read())

    text = extract_text_from_pdf("data/notice.pdf")
